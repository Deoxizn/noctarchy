...
- Root menu (`Super+Alt+Space`) briefly became a 67-row searchable flat index — reverted, it mixed submenu items into the top level and hurt navigation. Back to hierarchical drills; the flat table lives on as `noctarchy-menu-search` on `Super+Alt+/` instead ([`7e6d6d3`](https://github.com/deoxizn/noctarchy/commit/7e6d6d3), [`81e8982`](https://github.com/deoxizn/noctarchy/commit/81e8982), [`842ad53`](https://github.com/deoxizn/noctarchy/commit/842ad53))
