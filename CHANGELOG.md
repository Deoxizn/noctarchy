...
- Fix niri keybind `?` → `slash` (invalid key name) ([`2cc33a0`](https://github.com/deoxizn/noctarchy/commit/2cc33a0))
- Add `SUPER+Shift+/` hotkey overlay binding (later removed — duplicate of `SUPER+K`) ([`3857111`](https://github.com/deoxizn/noctarchy/commit/3857111))
- Remove `SUPER+Escape` power menu (redundant with `SUPER+Shift+Q`) ([`3857111`](https://github.com/deoxizn/noctarchy/commit/3857111))
...
- Clean up keybinds: remove duplicates (`Mod+Shift+T`, `Mod+Alt+D`), add `Mod+B`/`Mod+E` ([`d538cd6`](https://github.com/deoxizn/noctarchy/commit/d538cd6))
...
- Remap terminal: `Mod+T` → `Mod+Return` (SUPER+Enter, like Omarchy) ([`fd25490`](https://github.com/deoxizn/noctarchy/commit/fd25490))
- Swap launchers: `Mod+Space` = fuzzel (quick), `Mod+D` = Noctalia (full) ([`9fee91c`](https://github.com/deoxizn/noctarchy/commit/9fee91c))
...
- Fix `Mod+F` conflict: apps moved to `Mod+Shift+B/E/F` (Omarchy convention, avoids maximize-column conflict) ([`f0c323e`](https://github.com/deoxizn/noctarchy/commit/f0c323e))
- Remove duplicate `SUPER+Shift+/` hotkey overlay (kept `SUPER+K` for keybind list) ([`0dfabdc`](https://github.com/deoxizn/noctarchy/commit/0dfabdc))
...
- Website: remove duplicate Apps section, clean up keybinds table ([`53bfc26`](https://github.com/deoxizn/noctarchy/commit/53bfc26))
