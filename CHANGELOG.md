...
- Root menu (`Super+Alt+Space`) briefly became a 67-row searchable flat index — reverted, it mixed submenu items into the top level and hurt navigation. Back to hierarchical drills; the table lives on as `noctarchy-menu-search` on `Super+Alt+/`, now actions-only (container drills dropped) plus kernel variants, splash actions, and hardware-restart rows ([`7e6d6d3`](https://github.com/deoxizn/noctarchy/commit/7e6d6d3), [`81e8982`](https://github.com/deoxizn/noctarchy/commit/81e8982), [`842ad53`](https://github.com/deoxizn/noctarchy/commit/842ad53), [`d2e8ae7`](https://github.com/deoxizn/noctarchy/commit/d2e8ae7))
