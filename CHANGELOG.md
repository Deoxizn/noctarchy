...
- Make disk/network speed tests work on Niri: `noctarchy-speedtest` now uses `TUI.float` (1000×720 floating) instead of `noctarchy-terminal`, matching Hyprland's floating window
